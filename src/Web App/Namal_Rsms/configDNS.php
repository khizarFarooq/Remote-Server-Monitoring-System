      ...
      <div class="page-holder w-100 d-flex flex-wrap">
         <div class="container-fluid px-xl-3">
          <section class="py-3">
            <div class="row">
              <div class="col-lg-12">
                <form action="editDNS.php" method="POST">
                <div class="card">
                  <div class="card-header" style="background-color: #28bebd">
                    <center><h6 class="text-uppercase mb-0">Domain Name Server Info</h6></center>
                  </div>
                  <div class="card-body" > 
                  <div class="scrollable">
                   <table  class="table table-bordered text-center shadow px-5" >                     
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo '<tr class="table-info">
                  ...
                  <td style="width:100px">' . $row["FQDN"] .'</td>
                  <td>' . $row["Ping_service"] .'</td>
                  <td>' . $row["Port_service"] .'</td>
                  <td>' . $row["DNS_resolution"] .'</td>
