...
curl_close($curl);
     echo "<script type=\"text/javascript\">window.alert('Your Web server configuration updated successfully.');
window.location.href = 'configWeb.php';</script>";
exit;
} else {
