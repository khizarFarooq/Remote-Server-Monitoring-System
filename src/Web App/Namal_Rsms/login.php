    ...
    <div class="container">
      <div class="row align-items-center py-5">
       ...
       <div class="col-lg-7 px-lg-4">
        <center><h1 class="mb-4">Welcome back!</h1></center>
        <form action="validation.php" method="post" class="mt-4">
          <div class="form-group mb-4">
            <input type="text" name="email" placeholder="Email Address" required class="form-control border-0 shadow form-control-lg">
          </div>
          <div class="form-group mb-4">
          ...
          <div class="form-group mb-4">
            <div class="custom-control custom-checkbox">
              ...
              <button id="myBtn" class="btn btn shadow px-3" style="margin-left: 55%;background-color: #28bebd ;color: black;">Forget Password ?</button>
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-3 col-md-offset-4">
              
             <button type="submit" class="btn btn shadow px-5" style="margin-right: 15px;background-color: #28bebd ;color: black;">Log in</button>
           </div>
           <div class="col-md-6">
           </div>
         </div>
        ...
        <div id="myModal" class="modal">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <center><p>Enter your login email Address to send verification code : <input type="text" name="emailAddress"> <button type="submit" class="btn btn shadow px-3" style="background-color: #28bebd ;color: black;">Send</button></p></center>
