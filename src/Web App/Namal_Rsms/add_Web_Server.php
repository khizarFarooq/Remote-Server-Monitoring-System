...
include('databaseConnection.php');
 if(isset($_POST['insert']))  
 {
  ...
  $query = "UPDATE user_accounts_info SET profileImage=('$file') WHERE Name= '".$_SESSION['userName']."'";
      ...
      {  
           header("location:add_Web_Server.php"); 
      } 
 }
?>
    <!DOCTYPE html>
            ...
            <div class="row">
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header" style="text-align: center;background-color: #28bebd">
                    <h3 class="h5 text-uppercase mb-0">Welcome to add new Web Server</h3>
                    <div class="line" style="background: #000000"></div>
                    <h1 class="h5  mb-0">Host And Server Detail</h1>
                  </div>
                  <div class="card-body" style="text-align: center;">

                    <form class="form-horizontal" action="webServerRegistaration.php" method="post">
              ...
              <div class="form-group row">
                  ...
                  <label class="col-md-3 form-control-label">Enter the website URL :</label> 
                        <div class="col-md-3">
                          <input class="form-control"  name= "webUrl" placeholder="Website Url" class="form-control"> </div>  
                  ...
                  <div class="form-group row">
                       ...
                       <div class="custom-control custom-checkbox">
                            <input id="pingService" checked name="pingService" type="checkbox" class="custom-control-input" value ="yes">
                            <label for="pingService" class="custom-control-label">Ping to Host</label>
                          </div>
                          </div>
                          <div class="col-md-3">
                       <div class="custom-control custom-checkbox">
                            <input id="portService"checked name="portService" type="checkbox" class="custom-control-input" value ="yes">
                ...
                <label class="col-md-3 form-control-label"></label>
                  ...
                  <label class="col-md-4 form-control-label">Re-check the host and services after</label> 
                    ...
                    <div class="line"></div>
                          ...
                          <div class="col-md-6">
                          <button type="submit" name="action" value="webServerRegistration" class="btn btn shadow px-5" style="margin-right: 15px;background-color: #28bebd ;">Submit</button>
                          </div>
                          </div>
                    </form>
                  </div>
