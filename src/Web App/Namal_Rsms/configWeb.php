...
<html>
  <head>
    ...
    <title>Configure Web Server</title>
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-3">
          <section class="py-3">
            <div class="row">
            	<div class="col-lg-12">
                <form action="editWebServer.php" method="POST">
                <div class="card" >
                  <div class="card-header" card-header-icon card-header-rose style="background-color: #28bebd">
                    <center><h6 class="text-uppercase mb-0">Web Server Info</h6></center>
                  </div>
                  <div class="card-body"> 
