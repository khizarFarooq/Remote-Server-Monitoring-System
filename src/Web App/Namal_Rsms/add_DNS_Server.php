  ...
  include('databaseConnection.php');
   if(isset($_POST['insert']))  
   {
    ...
    $query = "UPDATE user_accounts_info SET profileImage=('$file') WHERE Name= '".$_SESSION['userName']."'";
        ...
        {  
             header("location:add_DNS_Server.php"); 
        } 
   }
  ?>
      <!DOCTYPE html>
                ...
                <div class="col-lg-12 mb-5">
                  <div class="card">
                    <div class="card-header" style="text-align: center;background-color: #28bebd ;">
                      <h3 class="h5 text-uppercase mb-0">Welcome to add new DNS Server</h3>
                      <div class="line" style="background: #000000"></div>
                      <h1 class="h5  mb-0">Host And Server Detail</h1>
                    </div>
                    <div class="card-body" style="text-align: center;">

                      <form action="dnsRegistaration.php" method="post" class="form-horizontal" #signupForm="ngForm">
                ...
                <div class="form-group row">
                	<label class="col-md-1 form-control-label"></label>
                	  <label class="col-md-4 form-control-label">Enter fully qualified domain name :</label> 
                          <div class="col-md-3">
                            <input class="form-control"  name= "fqdn"  oninvalid="setCustomValidity('Please enter valid FQDN.')"
                            onchange="try{setCustomValidity('')}catch(e){}"
                            type="text" placeholder="FQDN" class="form-control" required> </div>  
                    ...
                    <div class="form-group row">
                          <div class="col-md-4">
                            <div class="custom-control custom-checkbox">
                              <input id="pingService" checked name="pingService" value ="yes"type="checkbox" class="custom-control-input">
                              <label for="pingService" class="custom-control-label">Ping to Host</label>
                            </div>
                          </div>
                          <div class="col-md-3">
                          	<div class="custom-control custom-checkbox">
                              <input id="portService" checked name="portService" value="yes"type="checkbox" class="custom-control-input">
                              <label for="portService" class="custom-control-label">Server port availability</label>
                            </div>
                          </div>
                          <div class="col-md-4">
                          	<div class="custom-control custom-checkbox">
                              <input id="dnsResolution"checked name="dnsResolution" value="yes"type="checkbox" class="custom-control-input">
                	...
                	<label class="col-md-3 form-control-label"></label>
                	  ...
                	  <label class="col-md-4 form-control-label">Re-check the host and services after</label> 
                          <div class="col-md-2">
                            ...
                            <div class="col-md-3">
                            <input class="form-control"  name= "recheckTime" type="text" placeholder="Times" class="form-control" required pattern= "^[1-9]\d*$" oninvalid="setCustomValidity('Please enter valid input')"
                            onchange="try{setCustomValidity('')}catch(e){}"> </div>  
                      ...
                      <div class="line"></div>
                            ...
                            <div class="col-md-6">
                            <button type="submit" name="action" value="dnsRegistration" class="btn btn shadow px-5" style="margin-right: 15px;background-color: #28bebd ;">Submit</button>
                            </div>
                            </div>
                      </form>
                    </div>
