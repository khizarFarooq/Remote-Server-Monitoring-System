...
if(isset($_POST['insert']))  
 {
  ...
  $query = "UPDATE user_accounts_info SET profileImage=('$file') WHERE Name= '".$_SESSION['userName']."'";
      ...
      {  
           ...
           header("location:editProxyServer.php"); 
      } 
 }
$ID=$_POST['edit'];
$query="SELECT `ID`, INET_NTOA(`Host_ip`) AS inet, `Host_location`, `Server_name`, `Server_port`, `Web_url`, `Ping_service`,`Port_service`,`Https_service`,`Monitoring_config`,`Normal_checking_time`,`Recheck_time`,`Upto_time`FROM `proxy_server_info` Where ID=$ID";
...
?>
    ...
    <title>Edit Proxy Server Info</title>
            ...
            <div class="row">
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header" style="text-align: center;background-color: #28bebd ;">
                    <h3 class="h5 text-uppercase mb-0">Welcome to edit Proxy Server</h3>
                    <div class="line" style="background: #000000"></div>
                    <h1 class="h5  mb-0">Host And Server Detail</h1>
                  </div>
                  <div class="card-body" style="text-align: center;">

                    <form action="updateProxyServerInfo.php" method="post" class="form-horizontal" #signupForm="ngForm">
              ...
              <div class="form-group row">
                  ...
                  <label class="col-md-3 form-control-label">Enter the website URL :</label> 
                        <div class="col-md-4">
                          <input class="form-control"  name= "webUrl" value="<?php echo $webUrl; ?>"type="text" placeholder="Website Url" class="form-control" required> </div>  
